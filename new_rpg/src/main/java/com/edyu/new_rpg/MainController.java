...
import com.edyu.new_rpg.utils.BasicEnemy;
import com.edyu.new_rpg.utils.Boss;
import com.edyu.new_rpg.utils.Enemy;
import com.edyu.new_rpg.utils.Hero;
...
public class MainController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        for (Hero hero : PersonalizeHeroesController.heroes) {
        ...
        if(randomFight == 0) {
            ...
            for (int i = 0; i < PersonalizeHeroesController.heroes.size(); i++) {
